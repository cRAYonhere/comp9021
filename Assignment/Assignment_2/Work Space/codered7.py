...
'''
        ...
        if function_name==0:
            ...
            filename = str(self.filename)[0:-4] + '_worked_temp' + '.tex'
            ...
            for row in range(9):
                ...
                for column in range(9):
                    ...
                    if function_name==3:
                        try:
                            # temp_list=preemptive_dict[(row,column)][0]
                            for option in self.copy_options_dict[(row, column)]:
                ...
                if row==8:
                    slashn=''
                slashBigN='\\N'
                fstream.write(f'\n% Line {row+1}\n{slashBigN}{{{markup[0][0]}{space if markup[0][1] !=empty and markup[0][0] else empty}{markup[0][1]}}}{{{markup[0][2]}{space if  markup[0][3]!=empty and markup[0][2] else empty}{markup[0][3]}}}{{{markup[0][4]}{space if markup[0][5]!=empty and markup[0][4] else empty}{markup[0][5]}}}{{{markup[0][6]}{space if markup[0][7] !=empty and markup[0][6] else empty}{markup[0][7]}{space if markup[0][7] == empty  and markup[0][6] !=empty and markup[0][8]!=empty else empty}{space if markup[0][8]!=empty and markup[0][7] else empty}{markup[0][8]}}}{{{row_list[0]}}} & {slashBigN}{{{markup[1][0]}{space if markup[1][1]!=empty and markup[1][0] else empty}{markup[1][1]}}}{{{markup[1][2]}{space if markup[1][3]!=empty and markup[1][2] else empty}{markup[1][3]}}}{{{markup[1][4]}{space if markup[1][5]!=empty and markup[1][4] else empty}{markup[1][5]}}}{{{markup[1][6]}{space if markup[1][7]!=empty and markup[1][6] else empty}{markup[1][7]}{space if markup[1][7]==empty  and markup[1][6]!=empty  and markup[1][8]!=empty  else empty}{space if markup[1][8]!=empty and markup[1][7] else empty}{markup[1][8]}}}{{{row_list[1]}}} & {slashBigN}{{{markup[2][0]}{space if markup[2][1]!=empty and markup[2][0] else empty}{markup[2][1]}}}{{{markup[2][2]}{space if markup[2][3]!=empty and markup[2][2] else empty}{markup[2][3]}}}{{{markup[2][4]}{space if markup[2][5]!=empty and markup[2][4] else empty}{markup[2][5]}}}{{{markup[2][6]}{space if markup[2][7]!=empty and markup[2][6] else empty}{markup[2][7]}{space if markup[2][7]==empty  and markup[2][6]!=empty  and markup[2][8]!=empty  else empty}{space if markup[2][8]!=empty and markup[2][7] else empty}{markup[2][8]}}}{{{row_list[2]}}} &\n{slashBigN}{{{markup[3][0]}{space if markup[3][1]!=empty and markup[3][0] else empty}{markup[3][1]}}}{{{markup[3][2]}{space if markup[3][3]!=empty and markup[3][2] else empty}{markup[3][3]}}}{{{markup[3][4]}{space if markup[3][5]!=empty and markup[3][4] else empty}{markup[3][5]}}}{{{markup[3][6]}{space if markup[3][7]!=empty and markup[3][6] else empty}{markup[3][7]}{space if markup[3][8]!=empty and markup[3][7] else empty}{space if markup[3][7]==empty  and markup[3][6]!=empty  and markup[3][8]!=empty  else empty}{markup[3][8]}}}{{{row_list[3]}}} & {slashBigN}{{{markup[4][0]}{space if markup[4][1]!=empty and markup[4][0] else empty}{markup[4][1]}}}{{{markup[4][2]}{space if markup[4][3]!=empty and markup[4][2] else empty}{markup[4][3]}}}{{{markup[4][4]}{space if markup[4][5]!=empty and markup[4][4] else empty}{markup[4][5]}}}{{{markup[4][6]}{space if markup[4][7]!=empty and markup[4][6] else empty}{markup[4][7]}{space if markup[4][8]!=empty and markup[4][7] else empty}{space if markup[4][7]==empty  and markup[4][6]!=empty  and markup[4][8]!=empty  else empty}{markup[4][8]}}}{{{row_list[4]}}} & {slashBigN}{{{markup[5][0]}{space if markup[5][1]!=empty and markup[5][0] else empty}{markup[5][1]}}}{{{markup[5][2]}{space if markup[5][3]!=empty and markup[5][2] else empty}{markup[5][3]}}}{{{markup[5][4]}{space if markup[5][5]!=empty and markup[5][4] else empty}{markup[5][5]}}}{{{markup[5][6]}{space if markup[5][7]!=empty and markup[5][6] else empty}{markup[5][7]}{space if markup[5][8]!=empty and markup[5][7] else empty}{space if markup[5][7]==empty  and markup[5][6]!=empty  and markup[5][8]!=empty  else empty}{markup[5][8]}}}{{{row_list[5]}}} &\n{slashBigN}{{{markup[6][0]}{space if markup[6][1]!=empty and markup[6][0] else empty}{markup[6][1]}}}{{{markup[6][2]}{space if markup[6][3]!=empty and markup[6][2] else empty}{markup[6][3]}}}{{{markup[6][4]}{space if markup[6][5]!=empty and markup[6][4] else empty}{markup[6][5]}}}{{{markup[6][6]}{space if markup[6][7]!=empty and markup[6][6] else empty}{markup[6][7]}{space if markup[6][8]!=empty and markup[6][7] else empty}{space if markup[6][7]==empty  and markup[6][6]!=empty  and markup[6][8]!=empty  else empty}{markup[6][8]}}}{{{row_list[6]}}} & {slashBigN}{{{markup[7][0]}{space if markup[7][1]!=empty and markup[7][0] else empty}{markup[7][1]}}}{{{markup[7][2]}{space if markup[7][3]!=empty and markup[7][2] else empty}{markup[7][3]}}}{{{markup[7][4]}{space if markup[7][5]!=empty and markup[7][4] else empty}{markup[7][5]}}}{{{markup[7][6]}{space if markup[7][7]!=empty and markup[7][6] else empty}{markup[7][7]}{space if markup[7][8]!=empty and markup[7][7] else empty}{space if markup[7][7]==empty  and markup[7][6] !=empty  and markup[7][8] !=empty else empty}{markup[7][8]}}}{{{row_list[7]}}} & {slashBigN}{{{markup[8][0]}{space if markup[8][1]!=empty and markup[8][0] else empty}{markup[8][1]}}}{{{markup[8][2]}{space if markup[8][3]!=empty and markup[8][2] else empty}{markup[8][3]}}}{{{markup[8][4]}{space if markup[8][5]!=empty and markup[8][4] else empty}{markup[8][5]}}}{{{markup[8][6]}{space if markup[8][7]!=empty and markup[8][6] else empty}{markup[8][7]}{space if markup[8][8]!=empty and markup[8][7] else empty}{space if markup[8][7] ==empty  and markup[8][6] !=empty  and markup[8][8] !=empty  else empty}{markup[8][8]}}}{{{row_list[8]}}} \\\ \hline{ending}{slashn}')
