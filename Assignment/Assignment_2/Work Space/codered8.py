...
\end{document}
'''
        function_name_dict={0:'_bare_temp.tex',1:'_forced_temp.tex',2:'_marked_temp.tex',3:'_worked_temp.tex'}
        element_dict = {1: [0, 0], 2: [0, 1], 3: [1, 0], 4: [1, 1], 5: [2, 0], 6: [2, 1], 7: [3, 0], 8: [3, 1], 9: [3, 2]}
        ...
        if function_name == 3:
            for key,value in self.copy_options_dict.items():
                ...
                for element in value:
                    printing[key[0]][key[1]][element_dict[element][0]][element_dict[element][1]] += f'{{{str(element)}}}'
